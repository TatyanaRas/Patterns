...
import static ru.netology.testmode.test.data.DataGenerator.Registration.getRegisteredUser;
...
class AuthTest {
    ...
    @Test//Верный пароль и логин у зарегистрированного пользователя
    ...
    @Test//Не зарегистрированный пользователь
    ...
    @Test//Пользователь заблокирован
    ...
    @Test// Не верный логин у зарегистрированного пользователя
    ...
    @Test// Не верный пароль у зарегистрированного пользователя
